...
setTimeout(() => { let crawler1 = new Crawler({ crawlerId: 21, apiKey: credentials["youtube-scraper-1"] }); crawler1.run() }, Math.random() * 2000)
setTimeout(() => { let crawler2 = new Crawler({ crawlerId: 22, apiKey: credentials["youtube-scraper-2"] }); crawler2.run() }, Math.random() * 2000)
setTimeout(() => { let crawler3 = new Crawler({ crawlerId: 23, apiKey: credentials["youtube-scraper-3"] }); crawler3.run() }, Math.random() * 2000)
setTimeout(() => { let crawler4 = new Crawler({ crawlerId: 24, apiKey: credentials["youtube-scraper-4"] }); crawler4.run() }, Math.random() * 2000)
setTimeout(() => { let crawler5 = new Crawler({ crawlerId: 25, apiKey: credentials["youtube-scraper-5"] }); crawler5.run() }, Math.random() * 2000)
setTimeout(() => { let crawler6 = new Crawler({ crawlerId: 26, apiKey: credentials["youtube-scraper-6"] }); crawler6.run() }, Math.random() * 2000)
setTimeout(() => { let crawler7 = new Crawler({ crawlerId: 27, apiKey: credentials["youtube-scraper-7"] }); crawler7.run() }, Math.random() * 2000)
setTimeout(() => { let crawler8 = new Crawler({ crawlerId: 28, apiKey: credentials["youtube-scraper-8"] }); crawler8.run() }, Math.random() * 2000)
setTimeout(() => { let crawler9 = new Crawler({ crawlerId: 29, apiKey: credentials["youtube-scraper-9"] }); crawler9.run() }, Math.random() * 2000)
setTimeout(() => { let crawler10 = new Crawler({ crawlerId: 30, apiKey: credentials["youtube-scraper-10"] }); crawler10.run() }, Math.random() * 2000)

setTimeout(() => { let crawler1 = new Crawler({ crawlerId: 31, apiKey: credentials["youtube-scraper-1"] }); crawler1.run() }, Math.random() * 2000)
setTimeout(() => { let crawler2 = new Crawler({ crawlerId: 32, apiKey: credentials["youtube-scraper-2"] }); crawler2.run() }, Math.random() * 2000)
setTimeout(() => { let crawler3 = new Crawler({ crawlerId: 33, apiKey: credentials["youtube-scraper-3"] }); crawler3.run() }, Math.random() * 2000)
setTimeout(() => { let crawler4 = new Crawler({ crawlerId: 34, apiKey: credentials["youtube-scraper-4"] }); crawler4.run() }, Math.random() * 2000)
setTimeout(() => { let crawler5 = new Crawler({ crawlerId: 35, apiKey: credentials["youtube-scraper-5"] }); crawler5.run() }, Math.random() * 2000)
setTimeout(() => { let crawler6 = new Crawler({ crawlerId: 36, apiKey: credentials["youtube-scraper-6"] }); crawler6.run() }, Math.random() * 2000)
setTimeout(() => { let crawler7 = new Crawler({ crawlerId: 37, apiKey: credentials["youtube-scraper-7"] }); crawler7.run() }, Math.random() * 2000)
setTimeout(() => { let crawler8 = new Crawler({ crawlerId: 38, apiKey: credentials["youtube-scraper-8"] }); crawler8.run() }, Math.random() * 2000)
setTimeout(() => { let crawler9 = new Crawler({ crawlerId: 39, apiKey: credentials["youtube-scraper-9"] }); crawler9.run() }, Math.random() * 2000)
setTimeout(() => { let crawler10 = new Crawler({ crawlerId: 40, apiKey: credentials["youtube-scraper-10"] }); crawler10.run() }, Math.random() * 2000)
